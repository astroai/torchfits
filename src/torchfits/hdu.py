...
class Header(dict):
    ...
    def _repr_html_(self):
        ...
        html = [
            '<div tabindex="0" aria-label="FITS Header Table" style=\'max-height: 400px; overflow: auto; border: 1px solid #ddd; margin-bottom: 1em;\'>',
...
class HDUList:
    ...
    def _repr_html_(self):
        """HTML representation for Jupyter notebooks."""
        html = [
            '<div tabindex="0" aria-label="FITS HDU List Table" style=\'max-height: 400px; overflow: auto; border: 1px solid #ddd; margin-bottom: 1em;\'>',
            "<table style='border-collapse: collapse; width: 100%; margin: 0;'>",
            "<thead><tr>",
        ]
